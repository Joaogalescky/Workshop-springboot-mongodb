# Projeto: API Restful com SpringBoot e banco MongoDB (web services + NoSQL)
[![NPM](https://img.shields.io/npm/l/react)](https://github.com/Joaogalescky/Workshop-springboot-mongodb/blob/main/LICENSE) 

# Sobre o projeto

O projeto API Restful com SpringBoot e banco MongoDB (web services + NoSQL) é um projeto de estudo em back-end desenvolvida durante a 5ª sprint da bolsa de estudos de **Back-End SpringBoot AWS 2024**, organizado pela [Compass UOL](https://compass.uol/en/home/) como trilha de estudos.
